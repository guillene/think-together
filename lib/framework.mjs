...
### Scope
Apply thinking pauses to: **Coding tasks**, **Learning/Research tasks**, **Data Analysis tasks**, and **Orchestration decisions** (fix proposals, investigation findings, architecture analysis shared from sub-agents or worktrees)
Skip for: Work item filing, simple file operations, pure administrative tasks (creating worktrees, opening tabs, status checks)
...
**Exception:** Skip for typos or simple fixes.
