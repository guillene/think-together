...
import { DISMISSAL_WORDS, DELEGATION_WORDS, MULTITASK_THRESHOLD_MINUTES, MIN_ENGAGED_LENGTH } from "./constants.mjs";
...
ORDER BY s.created_at`;
  ...
  SUM(CASE
        ...
        WHEN length(trim(t.user_message)) >= ${MIN_ENGAGED_LENGTH} THEN 1
        ELSE 0
